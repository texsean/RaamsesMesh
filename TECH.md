# RaamsesMesh — Technical Reference

> Build instructions, pinouts, wiring diagrams, and LoRa protocol spec.
> For the project overview, see [README-RAAMSES.md](README-RAAMSES.md).
